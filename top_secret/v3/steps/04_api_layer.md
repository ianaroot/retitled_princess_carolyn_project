...
Create API layer for HTTP communication with Rails backend, handling client/server ID translation and CSRF tokens. This layer is foundational and must be created before SyncManager.
...
- Step01: Data Models (Node, Connection, Graph)
- Step 01: Utils (uuid.js)
